...
$1 2 0.00001f 543847 0 $TESTS_INPUT_DIR/circle.h5 $TESTS_OUTPUT_DIR/circle.h5 >> /dev/null
...
$1 32 0.001f 10000 0 $TESTS_INPUT_DIR/two-lines.h5 $TESTS_OUTPUT_DIR/two-lines.h5 >> /dev/null
...
$1 32 0.001f 45000 0 $TESTS_INPUT_DIR/two-lines.h5 $TESTS_OUTPUT_DIR/two-lines-one.h5 >> /dev/null
...
$1 32 0.001f 50000 0 $TESTS_INPUT_DIR/two-lines.h5 $TESTS_OUTPUT_DIR/two-lines-several.h5 >> /dev/null
...
$1 932 0.1f 1 0 $TESTS_INPUT_DIR/thompson_points_932.h5 $TESTS_OUTPUT_DIR/thompson.h5 >> /dev/null
...
$1 932 0.00001f 15000 0 $TESTS_INPUT_DIR/thompson_points_932.h5 $TESTS_OUTPUT_DIR/thompson.h5 >> /dev/null
./$TESTS_DIR/test-thompson.py $TESTS_OUTPUT_DIR/thompson.h5 $TESTS_REF_OUTPUT_DIR/thompson_points_932.h5
